classdef Workspace < handle
    ...
    methods
        ...
        function DisplayEnvironment(self)
            ...
            %burger? tray
            tray3Position = [-1.8, 0.95, 0.86];
            self.tray3Handle = PlaceObject(self.tray3File,tray3Position);
            RotateObject(self.tray3Handle, T6);
            ...
            lightPosition1 = [1,-2.55,1.21];
            self.lightHandle1 = PlaceObject(self.lightFile, lightPosition1);
            lightPosition2 = [-1.165,0.3,0.7];
            self.lightHandle2 = PlaceObject(self.lightFile, lightPosition2);
            RotateObject(self.lightHandle2,trotx(-pi/2));
